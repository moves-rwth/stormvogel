...
def test_pgc_mdp():
    ...
    state1 = regular_model.new_state(labels=["init", "1"], features={"x": 1})
    state2 = regular_model.new_state(labels=["2"], features={"x": 2})
    state0 = regular_model.new_state(labels=["0"], features={"x": 0})
